...
class ApiRequest:
    def __init__(self, parent_app=None):
        ...
        # print(self.parentApp)
        # self.parentApp.login_token()
    ...
    def login(self, data: dict, url: str):
        ...
        if request.status_code == 200:
            ...
            self.__token = request['access_token']
            self.userID = request['user_id']
    ...
    def refresh_token(self):
        ...
        # self.parentApp.homeWindow.destroy()
        self.parentApp.login_token()
        ...
        if request is not None:
            ...
            for i in request:
                if i == 'detail':
                    ...
                    break
            if flag is True:
                txt = request['detail'] == "Could not validate credentials"
                if data.status_code == 401 and txt:
                    # return True
                    return self.parentApp.login_token()
                else:
                    return False
