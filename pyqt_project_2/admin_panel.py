...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.userLine.setPlaceholderText(' Please enter user name')
        self.nameLine = QtWidgets.QLineEdit()
        self.nameLine.setPlaceholderText(' Please enter first name')
        self.familyLine = QtWidgets.QLineEdit()
        self.familyLine.setPlaceholderText(' Please enter last name')
        self.emailLine = QtWidgets.QLineEdit()
        self.emailLine.setPlaceholderText(' Please enter email address')
        self.phoneLine = QtWidgets.QLineEdit()
        self.phoneLine.setPlaceholderText(' Please enter phone number')
